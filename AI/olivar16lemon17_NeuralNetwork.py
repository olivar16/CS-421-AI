...
class AIPlayer(Player):
    ...
    def __init__(self, inputPlayerId):
        ...
        super(AIPlayer,self).__init__(inputPlayerId, "olivar16lemon17_neuralnetworks")

        #matrix of input weights
        self.inputToHiddenWeights = []

        #weights to last node
        self.hiddenWeightsToLastNode = []
    ...
    def neuralNetwork(self, currentState):
        ...
        #Input 0: NonQueen Ants
        numNonQueenAnts = 0

        #Input 1 : Enemy distance from our queen
        enemyDistFromQueen = 0
        ...
        #Input 2: Health of enemy queen
        queenHealth = enemyQueen.health 
        inputs.append(queenHealth)
    ...
    def initializeNeuralNetwork(self):
        ...
        for i in range(0,3):
            ...
            self.inputToHiddenWeights.append(nodeWeights)
        ...
        for i in range(0,5):
            self.hiddenWeightsToLastNode.append(random.random())
